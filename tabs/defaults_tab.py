...
HELP_TEXT: dict[str, str] = {
    ...
    "main_event_pull_chance": "During the event window, chance each step to bias attendees toward the main-event attractor node.",
    "main_event_strength_multiplier": "How strongly main-event/stage attractors are boosted while event is active. Higher = much stronger pull.",
    "turnback_rate": "Chance to avoid immediate backtracking. Low = more bouncing back; high = fewer instant reversals.",
    "forward_bias": "Momentum preference to keep heading in same direction. 0 = off, 1 = moderate, higher = straighter flow with less turning.",
