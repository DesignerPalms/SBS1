...
HELP_TEXT: dict[str, str] = {
    ...
    "show_day_hours": "Length of one show day in hours. Used to map simulation time into day buckets.",
    "main_event_days": "How many days the main-event/stage is active. Formula: event active only when day_index < main_event_days.",
